...
WaveshareEPaper4P2InB = waveshare_epaper_ns.class_(
    "WaveshareEPaper4P2InB", WaveshareEPaper
)
...
WaveshareEPaper7P5InV2B = waveshare_epaper_ns.class_(
    "WaveshareEPaper7P5InV2B", WaveshareEPaper
)
